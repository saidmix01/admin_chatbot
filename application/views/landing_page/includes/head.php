...
<head>
    ...
    <link href="<?=base_url()?>landing_page/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<?=base_url()?>landing_page/css/style.css" rel="stylesheet">

    <link href="<?=base_url()?>landing_page/styles/styles.css" rel="stylesheet">
</head>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h3 class="m-0 text-secondary"><span class="text-primary">WebCol</span>Soluciones</h3>
                </a>
